...
fn install_cargo_profiles(project_root: &Path, force: bool) -> OptimizerResult<()> {
    ...
    new_content.push('\n');
    new_content.push_str("# Optimized build profiles added by rust-build-optimizer\n");
...
# Fast build script generated by rust-build-optimizer
# Use rust-build-optimizer for more advanced features
